...
REM ============================================================
REM max_train_steps = 1
REM This file performs only a one-step validation run.
REM Use train_lora_example.bat for full production training.
REM
REM IMPORTANT:
...
accelerate launch ^
  ...
  --output_dir "%OUTPUT%" ^
  --output_name "Example_LoRA_LTX25_smoketest"
